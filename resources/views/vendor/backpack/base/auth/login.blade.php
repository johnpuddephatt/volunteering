...
@section('content')
    <div class="row m-t-40">
        <div class="col-md-4 col-md-offset-4">
            ...
            <div class="alert alert-warning">This login page is for admins only. Organisations looking to add opportunities should <a class="nav-link" href="{{ route('login') }}">{{ __('login here') }}.</a></div>
            <div class="box">
                <div class="box-body">
